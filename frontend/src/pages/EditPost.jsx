...
const EditPost = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    if (sanitizedTitle.length > 40) {
      alert("Title must not exceed 40 characters!");
      return;
    }
    ...
    try {
      ...
      alert("Failed to update post. Ensure title is within 40 characters.");
      console.log(err);
    }
  };
      ...
      <div className="px-6 md:px-[200px] mt-8">
        ...
        <form className="w-full flex flex-col space-y-4 md:space-y-8 mt-4">
          ...
          <textarea
            ...
            className="px-4 py-2 outline-none h-[200px]"
            placeholder="Enter post description"
          ></textarea>

          <div
            onClick={handleUpdate}
            className="bg-black text-white text-center px-4 py-2 font-semibold cursor-pointer"
          >
            Submit
          </div>
        </form>
